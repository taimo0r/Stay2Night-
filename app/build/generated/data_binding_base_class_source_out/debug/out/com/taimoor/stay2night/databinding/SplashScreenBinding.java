...
public final class SplashScreenBinding implements ViewBinding {
  ...
  private SplashScreenBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView backgroundImage, @NonNull TextView poweredBy) {
  ...
  public static SplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.powered_by;
      TextView poweredBy = rootView.findViewById(id);
      if (poweredBy == null) {
        break missingId;
      }

      return new SplashScreenBinding((ConstraintLayout) rootView, backgroundImage, poweredBy);
    }
